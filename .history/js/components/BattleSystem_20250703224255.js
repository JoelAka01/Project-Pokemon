export class BattleSystem {
   ...
   async performOpponentAttack() {
      ...
      if (this.playerHP <= 0) {
         ...
         // Le joueur survit, c'est maintenant à son tour
   ...
   async handleDoubleKO() {
      ...
      // Afficher une notification de double KO
      this.showDoubleKONotification();

      // Attendre 3 secondes pour la notification
      await this.delay(3000);
      ...
      if (this.game.opponent.hand.cards.length > 0) {
         ...
         // Attendre 2 secondes puis demander au joueur de placer sa carte
         await this.delay(2000);
         
         console.log("🎯 Au tour du joueur de placer sa carte");
         this.showPlayerReplacementNotification();
   ...
   showDoubleKONotification() {
      ...
      notification.innerHTML = `
         <div class="flex items-center space-x-2">
            <span>💀💀</span>
            <span>Double KO ! L'adversaire place sa carte en premier...</span>
         </div>
      `;
