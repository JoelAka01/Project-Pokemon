export class BattleSystem 
{
   ...
   async performOpponentAttack() {
      ...
      // Vérifier si le joueur a une carte active et des attaques
      if (!this.game.player.activeCard) {
      ...
      // Si le joueur n'a pas encore choisi d'attaque, demander de choisir
      if (!this.selectedPlayerAttack) {
         console.log("🎯 Le joueur doit choisir une attaque avant le combat");
