export class BattleSystem {
   ...
   async handleKOsAfterBattle() {
      ...
      if (playerWasKO && opponentWasKO) {
         ...
         // Seul l'adversaire est KO - remplacement automatique simple
         console.log("🤖 Adversaire KO - placement automatique simple");
         
         if (this.game.opponent.hand.cards.length > 0) {
            console.log("🤖 Placement immédiat d'une nouvelle carte adverse...");
            
            // Placement direct sans délai ni notification compliquée
